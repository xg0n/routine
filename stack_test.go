...
func TestCaptureStackTrace(t *testing.T) {
	...
	assert.Equal(t, "github.com/xg0n/routineid.TestCaptureStackTrace", frame.Function)
	...
	assert.Equal(t, "github.com/xg0n/routineid.TestCaptureStackTrace", frame2.Function)
...
func TestCaptureStackTrace_Deep(t *testing.T) {
	...
	assert.True(t, more)
	assert.Equal(t, "github.com/xg0n/routineid.captureStackDeepRecursive", frame.Function)
	assert.Equal(t, 93, frame.Line)
	//
	frame2, more2 := frames.Next()
	assert.True(t, more2)
	assert.Equal(t, "github.com/xg0n/routineid.captureStackDeepRecursive", frame2.Function)
