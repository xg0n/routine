...
func TestRuntimeError_Panic_Panic(t *testing.T) {
	defer func() {
		...
		//
		line = lines[1]
		assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestRuntimeError_Panic_Panic."))
...
func TestRuntimeError_Error_EmptyMessage_NilError(t *testing.T) {
	...
	//
	line = lines[1]
	assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestRuntimeError_Error_EmptyMessage_NilError() in "))
...
func TestRuntimeError_Error_EmptyMessage_NormalError(t *testing.T) {
	...
	//
	line = lines[2]
	assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestRuntimeError_Error_EmptyMessage_NormalError() in "))
...
func TestRuntimeError_Error_NormalMessage_NilError(t *testing.T) {
	...
	//
	line = lines[1]
	assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestRuntimeError_Error_NormalMessage_NilError() in "))
...
func TestRuntimeError_Error_NormalMessage_NormalError(t *testing.T) {
	...
	//
	line = lines[2]
	assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestRuntimeError_Error_NormalMessage_NormalError() in "))
...
func TestRuntimeError_Error_MainGoid(t *testing.T) {
	...
	//
	line = lines[1]
	assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestRuntimeError_Error_MainGoid() in "))
...
func TestRuntimeError_Error_ZeroGopc(t *testing.T) {
	...
	//
	line = lines[1]
	assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestRuntimeError_Error_ZeroGopc() in "))
...
func TestArgumentNilError_Panic_Panic(t *testing.T) {
	defer func() {
		...
		//
		line = lines[2]
		assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestArgumentNilError_Panic_Panic."))
...
func TestArgumentNilError_Error(t *testing.T) {
	...
	//
	line = lines[3]
	assert.True(t, strings.HasPrefix(line, "   at github.com/xg0n/routine.TestArgumentNilError_Error() in "))
